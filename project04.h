...
#define SCAN_TOKEN_STRINGS {"TK_INTLIT", "TK_BINLIT", "TK_HEXLIT", \
                            ...
                            "TK_EOT", "TK_ANY", "TK_NOT", "TK_AND", "TK_OR", "TK_XOR", "TK_RSHIFT", "TK_LSHIFT"};
...
enum parse_oper_enum {OP_PLUS, OP_MINUS, OP_MULT, OP_DIV, OP_NOT, OP_AND, OP_OR, OP_XOR, OP_RSHIFT, OP_LSHIFT};
